...
Дипломная работа Яндекс Практикум. Онлайн-сервис Foodgram и API для него.Имеется реализация CI/CD проекта.На этом сервисе пользователи могут публиковать рецепты, подписываться на публикации других пользователей, добавлять понравившиеся рецепты в список "Избранное", а перед походом в магазин скачивать сводный список продуктов, необходимых для приготовления одного или нескольких выбранных блюд.
...
```bash
   git clone https://github.com/Abramow79/foodgram-project-react
```
...
SSH_KEY=<ваш приватный SSH-ключ (для получения команда: cat ~/.ssh/id_rsa на локальном компьютере)>
...
#### После успешного результата работы workflow зайдите на виртуальную машину
...
Абрамов Андрей - [https://github.com/Abramow79/foodgram-project-react](https://github.com/Abramow79/)